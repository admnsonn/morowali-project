      ...
      <div class="grid-container">
        <div class="field1">
          <div class="form-group">
            ...
            <input
              type="text"
              v-model="model.warga.nama_lengkap"
              class="form-control"
              id="NamaLengkap"
              aria-label="nama"
        ...
        <div class="field11">
          <div class="form-group">
            ...
            <input
              type="text"
              v-model="model.warga.tempat_lahir"
              class="form-control"
              id="TTL"
              aria-label="ttl"
        ...
        <div class="field12">
          <div class="form-group">
            ...
            <input
              type="text"
              v-model="model.warga.status_pernikahan"
              class="form-control"
              id="Status"
              aria-label="ttl"
        ...
        <div class="field14">
          <div class="form-group">
            ...
            <input
              type="text"
              v-model="model.warga.tanggal_lahir"
              class="form-control"
              id="Tanggal"
              aria-label="tanggal"
