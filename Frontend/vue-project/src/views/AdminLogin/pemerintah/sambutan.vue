<template>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h3 class="title-warga">Data Sambutan Kepala Desa</h3>
                    ...
                    <table class="tabel">
                        ...
                        <tbody>
                            <tr v-for="(item, index) in displayedData" :key="index">
                                ...
                                <td>{{ item.sambutan }}</td>
                                <td>
                                    <router-link :to="`/pemerintahan/update-sambutan-kades/1`">
    ...
    methods: {
        ...
        filterData() {
            this.filteredData = this.tableData.filter((item) => {
                return (
                    item.sambutan.toLowerCase().includes(this.searchKeyword.toLowerCase())
                );
            });
