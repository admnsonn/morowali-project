            ...
            <div class="grid-container">
                ...
                <div class="field1">
                    <div class="form-group">
                        ...
                        <QuillEditor toolbar="essential" v-model:content="this.tableData[0].sejarah" theme="snow"
                            content-type="html" />
                    </div>
                </div>
    ...
    methods: {
        ...
        async updateData() {
            ...
            if (result.isConfirmed) {
                axios
                    .put("http://localhost:8080/pemerintah/sejarah/setting", {
                        sejarah: this.tableData[0].sejarah,
                        id_desa: this.id_desa,
                    })
                    .then((res) => {
                        if (res.data.status) {
                            Swal.fire("Data berhasil diubah.", res.data.message, "success");
                            this.$router.push('/pemerintahan/sejarah-desa');
                        } else {
