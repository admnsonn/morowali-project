<template>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <h3 class="title-warga">Ubah Data Program Kerja</h3>
            ...
            <div class="grid-container">
                ...
                <div class="field1">
                    <div class="form-group">
                        ...
                        <QuillEditor toolbar="essential" v-model:content="this.tableData[0].proker" theme="snow"
                            content-type="html" />
                    </div>
                </div>
    ...
    methods: {
        ...
        async updateData() {
            ...
            if (result.isConfirmed) {
                axios
                    .put("http://localhost:8080/pemerintah/proker/setting", {
                        proker: this.tableData[0].proker,
                        id_desa: this.id_desa,
                    })
                    .then((res) => {
                        if (res.data.status) {
                            Swal.fire("Data berhasil diubah.", res.data.message, "success");
                            this.$router.push('/pemerintahan/program-kerja');
                        } else {
