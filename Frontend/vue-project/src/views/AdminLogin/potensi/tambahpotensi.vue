        ...
        <div class="isi-tambahdata">
            <div class="grid-container">
                ...
                <div class="field1">
                    ...
                    <div class="form-group-foto" v-if="this.model.potensi.foto_potensi_desa">
                        <label for="foto">Preview foto</label>
                        <img :src="`data:image/png;base64,${this.model.potensi.foto_potensi_desa}`" alt="foto potensi"
                ...
                <div class="field2">
                    <div class="form-group">
                        ...
                        <input type="text" v-model="model.potensi.judul_potensi" class="form-control" id="Judul"
                ...
                <div class="field3">
                    <div class="form-group">
                        ...
                        <QuillEditor toolbar="essential" v-model="model.potensi.deskripsi" theme="snow"
                            content-type="html" />
                    </div>
                </div>
    ...
    methods: {
        async addNewData() {
            ...
            if (result.isConfirmed) {
                const plainTextDescription = this.model.potensi.deskripsi;
                axios
                    .post("http://localhost:8080/potensi_desa/tambah_potensi", {
                        id_potensi: this.model.potensi.id_potensi,
                        deskripsi: plainTextDescription,
                        judul_potensi: this.model.potensi.judul_potensi,
                        desa_id: this.model.potensi.desa_id,
                        foto_potensi_desa: this.model.potensi.foto_potensi_desa,
                    })
                    .then((res) => {
                        this.model.potensi = {
                            id_potensi: 1,
                ...
                img.onload = () => {
                    ...
                    canvas.toBlob((resizedBlob) => {
                        ...
                        reader.onloadend = () => {
                            ...
                            this.model.potensi.foto_potensi_desa = base64String;
