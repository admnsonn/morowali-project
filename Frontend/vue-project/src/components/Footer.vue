          ...
          <div class="col-md-4 mb-4">
            <ul class="nav justify-content-end">
              <li class="nav-item">
                ...
                <p class="nav-link text-white link_web py-1 mb-2"><a href="https://bungkutengah.com/">Kecamatan Bungku
                    Tengah</a>
                </p>
                <p class="nav-link text-white link_web mb-2"><a href="https://morowalikab.go.id/">Kabupaten Morowali</a>
                </p>
              </li>
...
export default {
  ...
  methods: {
    fetchData() {
      const apiResponse = {
        data: {
          alamat: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus ac scelerisque velit. Nam sit amet porta lectus, feugiat accumsan nisi. Sed tristique sem placerat velit luctus, sed sodales lectus consequat.",
